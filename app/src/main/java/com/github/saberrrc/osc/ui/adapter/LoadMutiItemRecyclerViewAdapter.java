...
public class LoadMutiItemRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LoadMutiItemRecyclerViewAdapter(FinalRecycleAdapter adapter) {
    ...
    /**
     * FinalRecycleAdapter 的class 与 布局 map
     *
     * @return
     */
    ...
    /*        mLoadMoreView = LayoutInflater.from(AppApplication.appContext).inflate(R.layout.activity_test1, null, false);
            ((RelativeLayout) mLoadMoreView).setGravity(Gravity.CENTER);*/
            mLoadMoreView = new TextView(AppApplication.appContext);
        ...
        return LoadMutiItemRecyclerViewAdapter.ViewHolder.createViewHolder(mLoadMoreView);
    }

    private ViewHolder getLoadFailedViewHolder() {
        if (mLoadMoreFailedView == null) {
            mLoadMoreFailedView = new TextView(AppApplication.appContext);
    ...
    private ViewHolder getNoMoreViewHolder() {
        if (mNoMoreView == null) {
            mNoMoreView = new TextView(AppApplication.appContext);
    ...
    public LoadMutiItemRecyclerViewAdapter setOnLoadListener(OnLoadListener onLoadListener) {
    ...
    public static class FinalRecycleAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if (mClassIntegerHashMap.containsKey(key)) {
                ...
                throw new RuntimeException("未添加进Map,或者class类型与布局不匹配！");
            }
        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public static LoadMutiItemRecyclerViewAdapter.ViewHolder createViewHolder(View itemView) {
            LoadMutiItemRecyclerViewAdapter.ViewHolder holder = new LoadMutiItemRecyclerViewAdapter.ViewHolder(itemView);
            return holder;
        }
